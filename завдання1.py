...
# меню
# доопрацьовано за зауваженнями учасників: додано пункти 7 і 8 для нових функцій
while True:
    c = input("\n1-показати 2-додати 3-видалити 4-сортувати 5-завдання 6-по балах 7-лідер 8-різниця 0-вихід: ")
    if c == "1":
        show()
    elif c == "2":
        add()
